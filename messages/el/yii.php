...
return array (
  ...
  'The active record cannot be deleted because it is new.' => 'Δεν είναι δυνατή η διαγραφή της ενεργούς εγγραφής, διότι είναι καινούρια.',
  'The active record cannot be inserted to database because it is not new.' => 'Δεν είναι δυνατή η εισαγωγή της ενεργούς εγγραφής στη βάση δεδομένων, διότι δεν είναι καινούρια.',
  'The active record cannot be updated because it is new.' => 'Δεν είναι δυνατή η ενημέρωση της ενεργούς εγγραφής, διότι είναι καινούρια.',
