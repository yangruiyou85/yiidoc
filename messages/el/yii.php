...
return array (
  ...
  '{attribute} is too short (minimum is {min} characters).' => 'Το {attribute} είναι πολύ μικρό (το ελάχιστο είναι {min}).',
  '{attribute} is too small (minimum is {min}).' => 'Το {attribute} είναι πολύ μικρό (το ελάχιστο είναι {min} χαρακτήρες).',
