 ...
 */
return array (
  'CWinCache requires PHP wincache extension to be loaded.' => 'Το CWinCache απαιτεί την επέκταση wincache της PHP να έχει φορτωθεί.',
  ...
  'Column "{column}" does not exist in table "{table}".' => 'Η στήλη "{column}" δεν υπάρχει στον πίνακα "{table}".',
  ...
  'Virtual attribute {name} must specify "asc" and "desc" options.' => 'Το εικονικό πεδίο {name} πρέπει να καθορίζει τις επιλογές "asc" και "desc".',
