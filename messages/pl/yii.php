...
return array (
  ...
  'CDbCacheDependency.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'DbCacheDependency.connectionID "{id}" jest nierpawidłowy. Upewnij się, że wskazuje on na ID komponentu CDbConnection aplikacji.',
  'CDbConnection failed to open the DB connection.' => 'CDbConnection nie potrafił otworzyć połączenia z bazą danych.',
  'CDbTestFixture.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbTestFixture.connectionID "{id}" jest nieprawdiłowy. Uperwnij się, że wskazuje on na ID komponentu CDbConnection aplikacji.',
  ...
  'CTypedMap<{type}> can only hold objects of {type} class.' => 'CTypedMap<{type}> może posiadać jedynie obiekty klasy {type}.',
  ...
  'Resetting PK sequence is not supported.' => 'Resetowanie sekwencji klucza podstawowego (PK) nie jest wspierane.',
  'Setting integrity check is not supported.' => 'Ustawianie sprawdzania spójności nie jest wspierane.',
  ...
  'The STAT relation "{name}" cannot have child relations.' => 'Relacja STAT "{name}" nie może posiadać relacji potomnych.',
  'The module path "{path}" is not a valid directory.' => 'Ścieżka modułu "{path}" nie jest poprawnym katalogiem.',
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" or "ccccc".' => 'Wzorzec dnia tygodnia powinien być jednym z następujących: "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" lub "ccccc".',
  'The pattern for month must be "M", "MM", "MMM", "MMMM", "L", "LL", "LLL" or "LLLL".' => 'Wzorzec miesiąca powinien być jednym z następujących: "M", "MM", "MMM", "MMMM", "L", "LL", "LLL" lub "LLLL".',
  ...
  '{attribute} must not be equal to "{compareValue}".' => 'Atrybut {attribute} nie może być równy "{compareValue}".',
