...
return array (
  ...
  'CDbTestFixture.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbTestFixture.connectionID "{id}" jest nieprawdiłowy. Upewnij się, że wskazuje on na ID komponentu aplikacji CDbConnection.',
  ...
  'Dropping a foreign key constraint is not supported by SQLite.' => 'Usuwanie ograniczenia klucza obcego nie jest wspierane przez SQLite',
  ...
  'The list is read only.' => 'Tę listę można tylko odczytywać.',
  'The map is read only.' => 'Tę mapę można tylko odczytywać.',
  ...
  'The pattern for hour in day must be "k" or "kk".' => 'Wzorcem formatowania godziny w ciągu dnia jest "k" lub "kk".',
  ...
  'The pattern for week in month must be "W".' => 'Wzorcem formatowania numeru tygodnia w miesiącu jest "W".',
  'The pattern for week in year must be "w".' => 'Wzorcem formatowania numeru tygodnia w roku jest "w".',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with a foreign key "{key}" that does not point to the parent table "{table}".' => 'Relacja "{relation}" w klasie rekordu aktywnego "{class}" jest zdefiniowana kluczem obcym "{key}", który nie wskazuje na tabelę rodzica "{table}".',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". There is no such column in the table "{table}".' => 'Relacja "{relation}" w klasie rekordu aktywnego "{class}" jest zdefiniowana nieprawidłowym kluczem obcym"{key}". Nie istnieje taka kolumna w tabeli "{table}".',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The columns in the key must match the primary keys of the table "{table}".' => 'Relacja "{relation}" w klasie rekordu aktywnego "{class}" jest określona nierpawidłowym kluczem obcym. Kolumny w kluczu muszą zgadzać się z kluczami głównymi tabeli "{table}".',
  ...
  '{attribute} is too big (maximum is {max}).' => 'Wartość w polu {attribute} jest zbyt wielka (maksimum stanowi {max}).',
  ...
  '{attribute} must not be equal to "{compareValue}".' => 'Pole {attribute} nie może być równe "{compareValue}".',
