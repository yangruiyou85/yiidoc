...
return array (
  ...
  'Get a new code' => '新しいコードを入手してください。',
  ...
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'テーブル "{table}" のキュエリにおいて、プライマリキー "{key}" の値が指定されていません。',
  ...
  'This content requires the <a href="http://www.adobe.com/go/getflash/">Adobe Flash Player</a>.' => 'コンテントは <a href="http://www.adobe.com/go/getflash/">アドビフラッシュプレーヤ</a>を必要とします。',
