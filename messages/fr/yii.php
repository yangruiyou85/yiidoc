...
return array (
  ...
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 'La relation "{relation}" de l\'Active Record "{class}" est invalide. La classe et la clef étrangère de l\'active record associé doivent être spécifiées.',
  ...
  'Application base path "{path}" is not a valid directory.' => 'Le chemin du dossier de base de l\'application "{path}" est invalide.',
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 'Le chemin du dossier d\'exécution "{path}" est invalide. Vérifiez que le proccessus du serveur web peut y accéder en écriture.',
  ...
  'CDbHttpSession.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbHttpSession.connectionID "{id}" est invalide. Vérifiez qu\'il référence l\'ID d\'un composant d\'application de type CDbConnection.',
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute nécessite une table "{table}" pour enregistrer les messages dans la base de données',
  ...
  'CMemCache requires PHP memcache extension to be loaded.' => 'L\'extension PHP memcache doit être chargée pour pouvoir utiliser CMemCache.',
  ...
  'Cache table "{tableName}" does not exist.' => 'La table de cache "{tableName}" n\'existe pas.',
  ...
  'Object configuration must be an array containing a "class" element.' => 'L\'objet configuration doit être un array contenant un élément "class".',
  ...
  'Queue data must be an array or an object implementing Traversable.' => 'Les données de la queue doivent être un array ou un objet qui implémente Traversable.',
  ...
  'Stack data must be an array or an object implementing Traversable.' => 'Les données de la pile doivent être un array ou un objet qui implémente Traversable.',
  'Table "{table}" does not have a column named "{column}".' => 'La table "{table}" n\'a pas de colonne "{column}"',
  'Table "{table}" does not have a primary key defined.' => 'Aucune clef primaire n\'est définie pour la table "{table}".',
  ...
  'The "view" property is required.' => 'La propriété "view" est requise.',
  ...
  'The asset "{asset}" to be pulished does not exist.' => 'L\'élément "{asset}" devant être publié est inexistant.',
  ...
  'The layout path "{path}" is not a valid directory.' => 'Le chemin d\'accès au gabarit "{path}" n\'est pas un dossier valide.',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'La relation "{relation}" définie dans l\'active record "{class}" a une clef étrangère "{key}" invalide. La clef étrangère ne pointe pas sur une table de jointure.',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The format of the foreign key must be "joinTable(fk1,fk2,...)".' => 'La relation "{relation}" définie dans l\'active record "{class}" a une clef étrangère invalide. Le clef étrangère doit être sous le format "joinTable(fk1,fk2,...)".',
  'The requested controller "{controller}" does not exist.' => 'Le contrôleur demandé "{controller}" est inexistant.',
  ...
  'The system view path "{path}" is not a valid directory.' => 'La chemin "{path}" d\'accès à la vue système n\'est pas un dossier valide.',
  'The table "{table}" for active record class "{class}" cannot be found in the database.' => 'La table "{table}" associée à l\'active record "{class}" est introuvable dans la base de données.',
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'La valeur de la clef primaire "{key}" n\'est pas fournie lors d\'une requête sur la table "{table}".',
  'The verification code is incorrect.' => 'Le code de vérification est incorrect.',
  'The view path "{path}" is not a valid directory.' => 'Le chemin "{path}" d\'accès à la vue n\'est pas un dossier valide.',
  ...
  'Unrecognized locale "{locale}".' => 'La locale "{locale}" n\'a pas été reconnu.',
  ...
  '{class} does not have attribute "{attribute}".' => '{class} n\'a pas d\'attribut "{attribute}".',
  '{class} does not have attribute "{name}".' => '{class} n\'a pas d\'attribut "{name}".',
  ...
  '{class}.allowAutoLogin must be set true in order to use cookie-based authentication.' => '{class}.allowAutoLogin doit être à true pour pouvoir utiliser l\'autentification par cookie.',
  '{class}::authenticate() must be implemented.' => '{class}::authenticate() doit être implémenté.',
