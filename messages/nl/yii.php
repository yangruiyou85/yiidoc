...
return array (
  ...
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute heeft tabel "{table}" nodig om berichten op te slaan.',
  ...
  'CMemCache requires PHP memcache extension to be loaded.' => 'Voor het gebruik van CMemCache moet de memcache extensie geladen zijn.',
  ...
  'CSecurityManager.validation must be either "MD5" or "SHA1".' => 'CSecurityManager.validation moet "MD5" of "SHA1" zijn.',
  ...
  'Cache table "{tableName}" does not exist.' => 'De Cache tabel "{tableName}" bestaat niet.',
  ...
  'Table "{table}" does not have a primary key defined.' => 'Tabel "{table}" heeft geen primary key.',
  ...
  'The "view" property is required.' => 'Het "view" property is vereist.',
  ...
  'The column "{column}" is not a foreign key in table "{table}".' => 'De kolom "{column}" is geen foreign key in de tabel "{table}".',
  ...
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Het patroon voor maand moet "M", "MM", "MMM", or "MMMM" zijn.',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'De relatie "{relation}" in active record class "{class}" werd opgeven met een ongeldige foreign key "{key}". De foreign key wijst naar geen van beide join-tabellen.',
  ...
  'The requested controller "{controller}" does not exist.' => 'De opgevraagde controller "{controller}" bestaat niet.',
  'The requested view "{name}" is not found.' => 'De opgevraagde view "{name}" is niet gevonden.',
  ...
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'De waarde voor de primary key "{key}" werd niet opgegeven tijdens het queryen van table "{table}".',
  ...
  'Unable to find the decorator view "{view}".' => 'Kan het decorator view "{view}" niet vinden.',
  'Unable to find the list item.' => 'Kan het lijst-item niet vinden',
  ...
  '{class} does not have attribute "{name}".' => '{class} heeft geen attribuut "{name}".',
