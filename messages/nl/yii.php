...
return array (
  ...
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 'Het runtime path voor de applicatie "{path}" is ongeldig. Dit moet een map zijn die schrijfbaar is voor de web server.',
  ...
  'CAssetManager.basePath "{path}" is invalid. Please make sure the directory exists and is writable by the Web server process.' => 'CAssetManager.basePath "{path}" is ongeldig. Dit moet een bestaande map zijn die schrijfbaar is voor de web server.',
  ...
  'The requested controller "{controller}" does not exist.' => 'De aangevraagde controller "{controller}" bestaat niet.',
  'The requested view "{name}" is not found.' => 'De aangevraagde view "{name}" is niet gevonden.',
