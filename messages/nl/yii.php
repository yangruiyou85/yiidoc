...
return array (
  ...
  'Alias "{alias}" is invalid. Make sure it points to an existing PHP file.' => 'Alias "{alias}" is ongeldig. Zorg ervoor het verwijst naar een bestaand PHP bestand.',
  ...
  'CCacheHttpSession.cacheID is invalid. Please make sure "{id}" refers to a valid cache application component.' => 'CCacheHttpSession.cacheID is ongeldig. Gelieve ervoor te zorgen dan "{id}" naar een geldige cache applicatie-component wijst.',
