 ...
 */
return array (
  'Alias "{alias}" is invalid. Make sure it points to an existing PHP file.' => 'Alias "{alias}" är inte giltigt. Kontrollera att det leder till en existerande PHP-fil.',
  'Application Log' => 'Applikationslogg',
  'CDbConnection failed to open the DB connection.' => 'CDbConnection misslyckades med att öppna DB-anslutningen.',
  'Failed to initialize the mcrypt module.' => 'Initialisering av mcrypt-modulen misslyckades.',
  'GD and FreeType PHP extensions are required.' => 'PHP-tilläggen GD och FreeType erfordras.',
  'The "range" property must be specified with a list of values.' => 'Propertyn "range" måste specificeras med en lista av värden.',
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" or "ccccc".' => 'Mönstret för veckodag måste vara "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" or "ccccc".',
  'Your request is invalid.' => 'Ogiltig förfrågan (request)',
  '{attribute} is in the list.' => '{attribute} finns i listan.',
