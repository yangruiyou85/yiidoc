...
return array (
  ...
  'CWinCache user cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache user cache bị tắt. Xin thiết lập wincache.ucenabled la On trong php.ini của bạn.',
