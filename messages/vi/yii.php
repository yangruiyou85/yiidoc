 ...
 */
return array (
  '"{path}" không phải là thư mục hợp lệ.' => '',
  '&lt; Trước' => '',
  '&lt;&lt; Đầu tiên' => '',
  'Active Record đòi hỏi phải có "db" CDbConnection application component.' => '',
  ...
  'Alias "{alias}" không hợp lệ. Hãy kiểm tra đảm bảo nó chỉ đúng đến một file hay thư mục tồn tại.' => '',
  'Đường dẫn gốc của ứng dụng "{path}" không hợp lệ.' => '',
  'Đường dẫn runtime của ứng dụng "{path}" không hợp lệ. Hãy kiểm tra đảm bảo thư mục đó có thể ghi được.' => '',
  ...
  '{attribute} quá ngắn (tối thiểu phải là {min} ký tự).' => '',
  '{attribute} quá nhỏ (tối thiểu phải là {min}).' => '',
  '{attribute} phải là một con số.' => '',
  '{attribute} phải là số nguyên.' => '',
  '{attribute} must be repeated exactly.' => '',
  '{attribute} phải là {type}.' => '',
  '{className} không hỗ trợ tính năng add().' => '',
  '{className} không hỗ trợ tính năng delete().' => '',
  '{className} không hỗ trợ tính năng flush().' => '',
  '{className} không hỗ trợ tính năng get().' => '',
  '{className} không hỗ trợ tính năng set().' => '',
  '{class} không có method tên là "{name}".' => '',
  '{class} không có thuộc tính "{attribute}".' => '',
  '{class} không có thuộc tính "{name}".' => '',
  ...
  '{widget} không tìm thấy view "{view}".' => '',
);
