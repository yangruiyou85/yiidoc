...
return array (
  ...
  'Resetting PK sequence is not supported.' => 'Nastavenie PK (primárneho kľúča) nie je podporované.',
  'Setting integrity check is not supported.' => 'Overenie integrity nie je podporované.',
  ...
  '{attribute} is of the wrong length (should be {length} characters).' => '{attribute} má nesprávnu dĺžku (mal by mať {length} znakov)',
  '{attribute} is too big (maximum is {max}).' => '{attribute} je príliš veľký (maximum je {max}).',
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} je príliš dlhý (maximum je {max} znakov).',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute} je príliš krátky (minimum je {min} znakov).',
  '{attribute} is too small (minimum is {min}).' => '{attribute} je príliš malý (minimum je {min}).',
  ...
  '{attribute} must be greater than "{compareValue}".' => '{attribute} musí byť väčší než "{compareValue}".',
  '{attribute} must be greater than or equal to "{compareValue}".' => '{attribute} musí byť väčší alebo rovný "{compareValue}".',
  '{attribute} must be less than "{compareValue}".' => '{attribute} musí byť menší ako "{compareValue}".',
  '{attribute} must be less than or equal to "{compareValue}".' => '{attribute} musí byť menší alebo rovný "{compareValue}".',
  '{attribute} must be repeated exactly.' => '{attribute} musí byť presne opakovaný.',
  '{attribute} must be {type}.' => '{attribute} musí byť typu {type}.',
  '{attribute} must be {value}.' => '{attribute} musí mať hodnotu {value}.',
  '{attribute} must not be equal to "{compareValue}".' => '{attribute} musí byť rovný "{compareValue}".',
