...
return array (
  ...
  '{className} does not support add() functionality.' => '{className} не поддържа метода add()',
  '{className} does not support delete() functionality.' => '{className} не поддържа метода delete()',
  '{className} does not support flush() functionality.' => '{className} не поддържа метода flush()',
  '{className} does not support get() functionality.' => '{className} не поддържа метода get()',
  '{className} does not support set() functionality.' => '{className} не поддържа метода set()',
