...
このスクリプトはサーバにおいて正しい版数のPHPを実行しているか、適切なPHP拡張をロードしているか、php.iniファイル設定が正しいか
を確認します。
</p>
...
<p>
<?php if($result>0): ?>
おめでとうございます。あなたのサーバコンフィギュレーションはYiiの全ての要求を満しています。
<?php elseif($result<0): ?>
あなたのサーバコンフィギュレーションはYiiの最低限の要求を満しています。もしあなたのアプリケーションが対応する機能を
使用している場合には以下の警告に注意してください。
<?php else: ?>
申し訳ありませんが、あなたのサーバコンフィギュレーションはYiiの要求を満していません。
<?php endif; ?>
</p>
