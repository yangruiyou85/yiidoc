...
return array (
  ...
  'The relation "{relation}" in active record class "{class}" is not specified correctly: the join table "{joinTable}" given in the foreign key cannot be found in the database.' => 'Relácia "{relation}" v aktívnom zázname "{class}" nie je špecifikovaná korektne: prepojená tabuľka "{joinTable}" uvedená vo foreign key nebola nájdená v databáze.',
  'The relation "{relation}" in active record class "{class}" is specified with a foreign key "{key}" that does not point to the parent table "{table}".' => 'Relácia "{relation}" v aktívnom zázname "{class}" je špecifikovaná prostredníctvom kľúča (foreign key) "{key}", ktorý neukazuje na rodičovskú tabuľku "{table}".',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". There is no such column in the table "{table}".' => 'Relácia "{relation}" v aktívnom zázname "{class}" je špecifikovaná pomocou neplatného kľúča (foreign key) "{key}". Uvedený stĺpec v tabuľke "{table}" neexistuje.',
