...
return array (
  ...
  'Base path "{path}" is not a valid directory.' => 'Base path "{path}" là một chỉ dẫn có hiệu lực.',
  ...
  'CWinCache requires PHP wincache extension to be loaded.' => 'CWinCache cần bản mở rộng của PHP wincache tải về',
  'CWinCache user cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => 'CWinCache user cache bị tắt. Xin thiết lập wincache.ucenabled mở lên trong php.ini của bạn. ',
  ...
  'Column name must be either a string or an array.' => 'Cột tên phải là một string hoặc mot array',
  ...
  'Extension path "{path}" does not exist.' => 'bản mở rộng của path "{path}" không có hiện hữu',
