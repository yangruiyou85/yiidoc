...
return array (
  ...
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Formatem kodowania miesiąca jest "M", "MM", "MMM", or "MMMM".',
  'The pattern for seconds must be "s" or "ss".' => 'Formatem kodowania sekund jest "s" or "ss".',
  'The pattern for time zone must be "z" or "v".' => 'Formatem kodowania strefy czasowej jest "z" or "v".',
