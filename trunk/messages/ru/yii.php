...
return array (
  ...
  'Column "{column}" does not exist in table "{table}".' => 'Столбец "{column}" не существует в таблице "{table}".',
  ...
  'Virtual attribute {name} must specify "asc" and "desc" options.' => 'Для виртуального атрибута {name} необходимо указать опции "asc" и "desc".',
