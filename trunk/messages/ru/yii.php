...
return array (
  ...
  '{class} does not have a method named "{name}".' => '{class} не имеет метод "{name}".',
  '{class} does not have attribute "{attribute}".' => '{class} не имеет атрибут "{attribute}".',
  ...
  'Active record "{class}" is trying to select an invalid column "{column}". Note, the column must exist in the table or be an expression with alias.' => 'ActiveRecord "{class}" пытается выбрать недопустимую колонку "{column}". Примечание: колонка должна существовать в таблице или являться выражением с алиасом.',
  ...
  'Yii application can only be created once.' => 'Приложение Yii может создаваться только один раз.',
