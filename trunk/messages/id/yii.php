...
return array (
  ...
  'Resetting PK sequence is not supported.' => 'Mereset urutan PK tidak didukung',
  'Setting integrity check is not supported.' => 'Mengeset pengecekan integritas tidak didukung',
  ...
  'The relation "{relation}" in active record class "{class}" is not specified correctly. The join table "{joinTable}" given in the foreign key cannot be found in the database.' => 'Relasi "{relation}" di kelas active record "{class}" tidak ditentukan dengan benar. Tabel join "{joinTable}" diberikan foreign key tidak dapat ditemukan di dalam database.',
  ...
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute memerlukan table database "{table}" untuk menyimpan log pesan.',
  'CMemCache requires PHP memcache extension to be loaded.' => 'CMemCache perlu extension PHP memcache di-load.',
  'CMultiFileUpload.name is required.' => 'Diperlukan CMultiFileUpload.name.',
  ...
  'Table "{table}" does not have a primary key defined.' => 'Table "{table}" tidak mendefinisikan primary key.',
  'The "view" property is required.' => 'Diperlukan properti "view".',
  'The column "{column}" is not a foreign key in table "{table}".' => 'Kolom "{column}" bukanlah foreign key di dalam table "{table}".',
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE" or "EEEEE".' => 'Pola untuk hari dalam seminggu harus "E", "EE", "EEE", "EEEE" atau "EEEEE".',
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Pola untuk bulan harus "M", "MM", "MMM", atau "MMMM".',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'Relasi "{relation}" dalam kelas active record "{class}" ditetapkan dengan foreign key "{key}" yang tidak valid. Foreign key tidak menunjuk ke table yang di-join.',
  'The requested controller "{controller}" does not exist.' => 'Controller "{controller}" yang di-request tidak ada.',
  'The requested view "{name}" is not found.' => 'View "{name}" yang di-request tidak ditemukan.',
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'Nilai primary key "{key}" tidak disediakan saat melakukan queri table "{table}".',
  ...
  'CSecurityManager requires PHP mcrypt extension to be loaded in order to use data encryption feature.' => 'CSecurityManager memerlukan ekstensi PHP mcrypt di-load agar dapat menggunakan fitur enkripsi data.',
  ...
  'Filter "{filter}" is invalid. Controller "{class}" does have the filter method "filter{filter}".' => 'Filter "{filter}" tidak valid. Controller "{class}" tidak memiliki metode filter "filter{filter}".',
